...
import { getJavascriptPosts } from "../../services";
  ...
  return (
    <>
      ...
      <HeaderCategories
        ...
        categoryDescription={"The King of the browser"}
      />
      <section>
        ...
        <div className="container max-w-6xl px-6 mx-auto space-y-6 sm:space-y-12">
          <FeaturedPostsByCategory category="JAVASCRIPT" />
          <div className="">
...
export async function getStaticProps() {
  const posts = (await getJavascriptPosts()) || [];
  return {
    props: { posts },
  };
}
